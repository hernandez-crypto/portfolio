...
const projectList = [
  ...
  },
  {
    ...
    description: (
      <p>
        Language learning app for French. Utilizes spaced repetition algorithm
        to assist with memorization. Developed with a partner :{' '}
        <a
